    ...
    function signup()
{
    ...
    form.append("doctorname",document.getElementById("doctorname").value);
    form.append("email",document.getElementById("email").value);
    form.append("password",document.getElementById("password").value);
    form.append("start_slot",document.getElementById("start_slot").value);
    form.append("end_slot",document.getElementById("end_slot").value);
    form.append("slot_price",document.getElementById("slot_price").value);
    form.append("phoneno",document.getElementById("phoneno").value);
    form.append("catid",document.getElementById("catid").value);
...
//)
  ...
  xhttp.open("POST", "./doctorsignup", true);
  xhttp.send(form);  
}
    </script>
</head>
    ...
    <%
        ...
        <%
            ...
            %>
              ...
              <div class="col-lg-6">
<div class="form-group">
<input type="text" name="doctorname" id="doctorname" placeholder="doctor name" required>
</div>
</div>
<div class="col-lg-6">
<div class="form-group">
<input type="email" name="email" id="email" placeholder="doctor Email" required>
</div>
</div>
<div class="col-lg-6">
<div class="form-group">
...
<div class="col-lg-6">
<div class="form-group">
<input type="password"  name="confpass" id="confpass"  placeholder="conf password" required>
</div>
</div>
<div class="col-lg-6">
<div class="form-group">
...
<div class="col-lg-6">
<div class="form-group">
    <input type="time" name="start_slot" id="start_slot" placeholder="start slot" required>
</div>
</div>
    <div class="col-lg-6">
<div class="form-group">
    <input type="time" name="end_slot" id="end_slot" placeholder="end slot" required>
</div>
</div>
    <div class="col-lg-6">
<div class="form-group">
    <input type="number" name="slot_price" id="slot_price" placeholder="slot price" required>
</div>
</div>
                <div class="col-lg-6">
<div class="form-group">
